QGPagingToolbarAutorizPst = Ext.extend(Ext.Toolbar, {
    /**
		...
		if(this.idGrid)
   		...
   		var callBackCargarGrid = function(correcto,datosResultado){
			if(correcto){
				...
				Ext.getCmp('gridAutorizaciones').getStore().proxy =  new Ext.ux.data.PagingMemoryProxy(datosResultado.datos);							    												
	 			Ext.getCmp('gridAutorizaciones').getStore().load({params: {start: 0, limit: 100}});	    				 	
	 			Ext.getCmp('gridAutorizaciones').getView().refresh();
    ...
    onDestroy : function(){
        this.bindStore(null);
        QGPagingToolbarAutorizPst.superclass.onDestroy.call(this);
    }
    
}); 
   

Ext.reg('cgpaging', QGPagingToolbarAutorizPst);

if(QGPagingToolbarAutorizPst){
  Ext.apply(QGPagingToolbarAutorizPst.prototype, {
