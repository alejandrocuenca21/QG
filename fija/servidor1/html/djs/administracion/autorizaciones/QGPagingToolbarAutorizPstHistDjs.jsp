QGPagingToolbarAutorizPstHist = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        QGPagingToolbarAutorizPstHist.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
    ...
    movePrevious : function(criterio){
		...
		llamadaAjax('Autorizaciones.do','anterior','busquedaJSON',busqueda,callBackCargarGrid,true,true);
    },
    ...
    moveNext : function(criterio){    	
		...
		llamadaAjax('Autorizaciones.do','siguiente','busquedaJSON',busqueda,callBackCargarGrid,true,true);
    ...
    onDestroy : function(){
        this.bindStore(null);
        QGPagingToolbarAutorizPstHist.superclass.onDestroy.call(this);
    }
    
}); 
   

Ext.reg('cgpaging', QGPagingToolbarAutorizPstHist);

if(QGPagingToolbarAutorizPstHist){
  Ext.apply(QGPagingToolbarAutorizPstHist.prototype, {
