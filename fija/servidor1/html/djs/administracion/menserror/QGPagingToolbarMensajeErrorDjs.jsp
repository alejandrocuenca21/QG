QGPagingToolbarMensajeError = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        QGPagingToolbarMensajeError.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
    ...
    movePrevious : function(){
		...
		if(this.idGrid)
   		...
   		var callBackObtener = function(correcto,datosResultado){
			if(correcto){
				...
				Ext.getCmp('gridMensajeError').getStore().proxy =  new Ext.ux.data.PagingMemoryProxy(datosResultado.datos);							    												
		 		Ext.getCmp('gridMensajeError').getStore().load({params: {start: 0, limit: 100}});	    				 	
		 		Ext.getCmp('gridMensajeError').getView().refresh();
   			}
		}
		...
		llamadaAjax('MensError.do','anterior','menserrorJSON',datosObtener,callBackObtener,true,true);	
    },
    ...
    moveNext : function(){ 
		...
		llamadaAjax('MensError.do','siguiente','menserrorJSON',datosObtener,callBackObtener,true,true);	
    ...
    onDestroy : function(){
        this.bindStore(null);
        QGPagingToolbarMensajeError.superclass.onDestroy.call(this);
    }
    
}); 
   

Ext.reg('cgpaging', QGPagingToolbarMensajeError);

if(QGPagingToolbarMensajeError){
  Ext.apply(QGPagingToolbarMensajeError.prototype, {
