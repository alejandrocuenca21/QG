QGPagingToolbarPresegmentacion = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        QGPagingToolbarPresegmentacion.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
		...
		if(this.idGrid)
   		...
   		var callBackObtenerDatos = function(correcto,datosResultado){
			if(correcto){
				...
				Ext.getCmp('gridBuscadorSegmentos').getStore().proxy =  new Ext.ux.data.PagingMemoryProxy(datosResultado.datos);							    												
		 		Ext.getCmp('gridBuscadorSegmentos').getStore().load({params: {start: 0, limit: 100}});	    				 	
		 		Ext.getCmp('gridBuscadorSegmentos').getView().refresh();
   			}
		}

   		var entrada = ultimaBusqueda.get('entradaBusqueda');
		entrada.pgnTx = hayPaginacion;
		entrada.nejecucion = nejecucion;
    ...
    moveNext : function(){ 
		...
		if(this.idGrid)
   		...
   		var entrada = ultimaBusqueda.get('entradaBusqueda');
		entrada.pgnTx = posicionPaginacion;
		entrada.nejecucion = nejecucion;
    ...
    onDestroy : function(){
        this.bindStore(null);
        QGPagingToolbarPresegmentacion.superclass.onDestroy.call(this);
    }
    
}); 
   

Ext.reg('cgpaging', QGPagingToolbarPresegmentacion);

if(QGPagingToolbarPresegmentacion){
  Ext.apply(QGPagingToolbarPresegmentacion.prototype, {
