QGPagingToolbarPresegmentacionHist = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        QGPagingToolbarPresegmentacionHist.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
    ...
    onLoad : function(store, r, o){
        ...
        this.inputItem.setValue(nejecucionHist+1);
        this.prev.setDisabled(nejecucionHist == 0);
        this.next.setDisabled(hayPaginacionHist != "S");
    ...
    movePrevious : function(){
		...
		if (nejecucionHist > 0){
			nejecucionHist = nejecucionHist - 1;
		}
   		...
   		var callBackObtenerDatos = function(correcto,datosResultado){
			if(correcto){
				...
				posicionPaginacionHist = datosResultado.pgnTx;
 				...
 				Ext.getCmp('gridHistorico').getStore().proxy =  new Ext.ux.data.PagingMemoryProxy(datosResultado.datos);							    												
		 		Ext.getCmp('gridHistorico').getStore().load({params: {start: 0, limit: 100}});	    				 	
		 		Ext.getCmp('gridHistorico').getView().refresh();
   			}
		}
		...
		llamadaAjax('Presegmentacion.do','anterior','segmentacionPresegJSON',entrada,callBackObtenerDatos,true,true);	
    },
    ...
    moveNext : function(){ 
		...
		var callBackObtenerDatos = function(correcto,datosResultado){
   		...
   		var entrada = {
			...
			ofAtencion: "",
			tandem: "",
			pgnTx: posicionPaginacionHist,
			nejecucion: nejecucionHist,
			tipoConsulta: "01",
			inVigencia: "T"	
		};
   		   
		llamadaAjax('Presegmentacion.do','siguiente','segmentacionPresegJSON',entrada,callBackObtenerDatos,true,true);	
	},
    ...
    onDestroy : function(){
        this.bindStore(null);
        QGPagingToolbarPresegmentacionHist.superclass.onDestroy.call(this);
    }
    
}); 
   

Ext.reg('cgpaging', QGPagingToolbarPresegmentacionHist);

if(QGPagingToolbarPresegmentacionHist){
  Ext.apply(QGPagingToolbarPresegmentacionHist.prototype, {
