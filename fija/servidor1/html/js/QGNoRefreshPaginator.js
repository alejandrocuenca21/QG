NoRefreshPagingToolbar = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        NoRefreshPagingToolbar.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
             * Fires after the active page has been changed.
             * @param {NoRefreshPagingToolbar} this
             ...
             * @param {NoRefreshPagingToolbar} this
             * @param {Object} params An object hash of the parameters which the NoRefreshPagingToolbar will send when
    ...
    onDestroy : function(){
        this.bindStore(null);
        NoRefreshPagingToolbar.superclass.onDestroy.call(this);
    }
});

Ext.reg('cgpaging', NoRefreshPagingToolbar);
/*
 * Codigo propio
*/
if(NoRefreshPagingToolbar){
	  Ext.apply(NoRefreshPagingToolbar.prototype, {
