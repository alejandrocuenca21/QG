var CGLOBAL = function (){
    ...
    var cargarTipoDocumento = function (linea,modalidad){
		...
		myMask.show();
    	Ext.Ajax.request({
    		url:contexto + 'ListaClientesTW.do',
    		params:parametros,
	...
	var obtenerHistorico = function(criterioBusqueda){			
			...
			llamadaAjax('ListaClientesTW.do','obtenerHistorico','listaClientesJSON',datos,callBackResultadoBusquedaHistorico,true);		
		}		
   ...
   // Controlamos los eventos sobre los botones
	...
	var imprimirClientes = function() {
		...
		document.getElementById('ifExportar').src = contexto + 'ListaClientesTW.do?exportarPDF=&listaClientesJSON='+Ext.encode(cliente);	
	}
