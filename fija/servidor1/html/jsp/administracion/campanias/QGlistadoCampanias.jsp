...
<div class="recCentral">
	...
	<div class="recCentCont">
		...
		<sec:authorize ifAnyGranted="ROLE_AD,ROLE_SA,ROLE_AB">
		<div id="idFormCampania" class="formListDet" style="display:none;">
		<html:form action="/Campanias">
			<html:hidden styleId="hiddenUsuarioAlta" name="QGCampaniasForm" property="usuarioLogado" />
		</html:form>
			<span class="titFormListado">Campa&ntilde;a</span>
			<div class="formCont">
				<div class="pRel">
				...
				<div class="formDatAdm">
					<div class="fLeft">
						<table>
							<colgroup><col width="180"/><col width="*"/><col width="*"/></colgroup>
							<tbody>
								<tr>
									<td>
										<label>C&oacute;digo</label><br />
										<input type="text" maxlength="15" class="wtc15" id="txtCodigo" />
									</td>
									<td class="vBot">
					...
					<div>	
						<label>Descripci&oacute;n (m&aacute;x. 60 caracteres)</label><br />
						<input type="text" class="wtc60" maxlength="60" id="txtDescripcion" />
					</div>
					<div>
						<label>Observaciones (m&aacute;x. 160 caracteres)</label><br />
						<textarea rows="3" class="wTA600" onKeyPress="return maxlengthArea(this.id,event,160);" id="txtObservaciones"></textarea>
					</div>
				</div>
				<div class="pRel">
