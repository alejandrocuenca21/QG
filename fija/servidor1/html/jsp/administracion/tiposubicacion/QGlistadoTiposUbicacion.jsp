...
<div class="recCentral">
		<div class="recHead">
			...
			<h2>Tipos de Ubicaci&oacute;n</h2>
		</div>
		...
		<div class="recCentCont">
			...
			<sec:authorize ifAnyGranted="ROLE_AD,ROLE_SA,ROLE_AB">
			<div id="idFormTiposUbicacion" class="formListDet" style="display:none;">
			<html:form action="/TiposUbicacion">
				<html:hidden styleId="hiddenUsuarioAlta" name="QGTiposUbicacionForm" property="usuarioLogado" />
			</html:form>
				<span class="titFormListado">Tipo de ubicaci&oacute;n</span>
				<div class="formCont">
					<div class="pRel">
								...
								<tbody>
									<tr>
										<td>
											...
											<input type="text" maxlength="2" class="wtc2" id="txtCodigo" />
										</td>
										<td class="vBot">
