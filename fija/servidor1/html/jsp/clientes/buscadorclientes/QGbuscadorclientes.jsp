...
<html:form action="/ListaClientes" method="POST">
	<html:hidden styleId="hiddenVueltaFC" property="vuelta" name="QGListaClientesForm"/>
</html:form>		
<%
			...
			<div class="recCentCont">
				...
				<div class="formBusc">
					...
					<div class="formBuscCont">
						...
						<div class="colA" style="width:80px">
							<label>LN/Modalidad:</label><br/>
							<select id="selNegocio" class="wtc8">
								<option value="">   </option>
							</select>
						</div>
						<div class="colB" style="width:33%">
							<table>
								<tbody>
									<tr>
										<td><input type="radio" id="radCod" class="noBrd" name="radCodDoc" value="radCodigo" /></td>
										<td>
									...
									<tr>
										<td><input type="radio" id="radTipoDoc" class="noBrd" name="radCodDoc" value="radDoc" /></td>
										<td>
											<label>Documento identificaci&oacute;n:</label><br />
											<select name="select" id="selTipoDoc" class="wtc10">
											</select>
							...
							<table>
								<tbody>
									<tr>
										...
										<td><input type="radio" id="radNombre" class="noBrd" name="radCodDoc" value="radNombre"/></td>
									...
									<tr>
										<td><input type="radio" id="radRazon" class="noBrd" name="radCodDoc" value="radRazonSoc" /></td>
