...
window.onload = function() {
    ...
    for (var i = 0; i < accesosJS.length; i++) {
      ...
      if (valor === "QG") {
        ...
        label = "Gestión de la información para Publicaciones y servicios de Información";
      } else {
        label = valor;
      }
        ...
        return function() {         
          // Redirigir si quieres:
           if (acceso === "QG") {
             ...
             window.location.href = contexto + "vIndexMenuTW.do";
           } else if (acceso === "D4") {
             window.location.href = contexto + "vIndexMenuD4.do";
           } else {
